        ...
        <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className="relative w-full overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <div
                        ref={leftDiamondRef}
                        className="pointer-events-none absolute w-[300px] h-[350px] transform rotate-45 border-2 border-gray-300 border-dotted opacity-30 lg:left-[-225px] lg:w-[450px] lg:h-[450px] lg:opacity-60"
                    ></div>

                    {/* Right Diamond */}
                    <div
                        ref={rightDiamondRef}
                        className="pointer-events-none absolute w-[350px] h-[350px] transform rotate-45 border-2 border-gray-400 border-dotted opacity-60 lg:right-[-225px] lg:w-[450px] lg:h-[450px]"
                    ></div>

                    {/* Extra Diamonds (Initially Hidden) */}
                    <div
                        ref={extraDiamond1Ref}
                        className="pointer-events-none absolute w-[350px] h-[350px] transform rotate-45 border-2 border-gray-300 border-dotted opacity-0 lg:right-[-200px] "
                    ></div>
                    <div
                        ref={extraDiamond2Ref}
                        className="pointer-events-none absolute w-[350px] h-[350px] transform rotate-45 border-2 border-gray-200 border-dotted opacity-0 lg:right-[-175px]"
                    ></div>
                    ...
                    <div
                        ref={discoverRef}
                        className="discover-ai-btn hidden items-center justify-center gap-4 lg:flex lg:flex-row-reverse lg:absolute left-16"
                    >
